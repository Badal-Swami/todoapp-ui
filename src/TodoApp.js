...
const GET_TASKS_API_BASE_URL = 'http://get-task.badalswami.online';
const DELETE_TASK_API_BASE_URL = 'http://delete-task.badalswami.online';
const CREATE_TASK_API_BASE_URL = 'http://add-task.badalswami.online';
